...
<header class="header">
    ...
    <nav class="navbar">
        ...
        <a href="buisnesslogin.php" type="button" class="btn btn-warning"><h5>Logout</h5></a>
    </nav>
...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="content">
            <h3>Who are we?</h3>
            <p>We are catalyst between you and the Buyers to help you grow your small buisness.</p>
...
<section class="menu" id="menu">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="orderdetails.php" class="btn">View orders</a>
        </div>
...
<section class="review" id="review">
    ...
    <h1 class="heading"> 
Entrepreneur <span> Feedbacks</span> </h1>

    <div class="box-container">

        <div class="box">
            <img src="images1/quote-img.png" alt="" class="quote">
            <p>This website proved very helpful for growing my small buisness.</p>
            <img src="images1/pic-4.png" class="user" alt="">
            <h3>Rhea Paul</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
        ...
        <div class="box">
            <img src="images1/quote-img.png" alt="" class="quote">
            <p>This website is very much helpful as it provides a platform to sell our homemade products to people.</p>
            <img src="images1/pic-3.png" class="user" alt="">
            <h3>Tim Burner</h3>
            <div class="stars">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
...
<section class="footer">
    ...
    <div class="links">
        ...
        <a href="#">feedback</a>
        <a href="#">contact us</a>
        <a href="buisnesslogin.php">Logout</a>
