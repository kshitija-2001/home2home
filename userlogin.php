...
<body>
<h2>Help us to support small business!</h2>
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form method="POST" action="usersign_back.php">
          <h1>Sign Up</h1>
          <label>
            <span>Name</span>
	...
	<div class="form-container sign-in-container">
		...
		<form method="POST" action="userlogin_back.php">
		<h1> Sign In </h1>
        <label>
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-left">
				<h1>Welcome Back!</h1>
				<p>Glad you are back! Start ordering now!</p>
				<button class="ghost" id="signIn">Sign In</button>
			</div>
			<div class="overlay-panel overlay-right">
				<h1>Hello, Friend!</h1>
				<p>Enter your personal details and start ordering</p>
